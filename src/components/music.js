...
const Music = () => {
    return (
        <div>
            ...
            <div id="abstractAudio" class="songSelect" href="audio/Abstract.mp3">
                <ul>
                    <li>1. Abstract</li>
                    <li>MP3</li>
                    <li>2013</li>
            ...
            <div id="pianoGuitarAudio" class="songSelect" href="audio/For%20Piano%20and%20Guitar%20v3.mp3">
                <ul>
